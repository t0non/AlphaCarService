...
export const metadata: Metadata = {
  ...
  description: 'Embreagem pesada, patinando ou trepidando? Realizamos o diagnóstico e troca de kit de embreagem em Belo Horizonte.',
};
      ...
      <main className="flex-1 bg-white pt-24 pb-16">
        <div className="container mx-auto px-6 lg:px-8 max-w-4xl">
          <nav className="text-sm text-muted-foreground mb-6">
            <a href="/" className="hover:underline">Home</a> &gt; <a href="/servicos" className="hover:underline">Serviços</a> &gt; <span className="text-foreground">Troca de Embreagem Automotiva</span>
          </nav>
          
          <h1 className="text-4xl font-bold tracking-tight text-foreground mb-8">
            Troca de Embreagem Automotiva
          </h1>
          
          <div className="prose prose-lg text-muted-foreground mb-12">
            <p className="text-xl font-medium text-foreground leading-relaxed">
              Se o seu carro perdeu força nas subidas ou o pedal ficou muito duro, a embreagem pode estar no fim de sua vida útil. Avaliamos o platô, disco e rolamento.
            </p>
          ...
          <div className="bg-secondary/30 p-8 rounded-xl border border-secondary text-center mt-12">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button asChild size="lg" className="bg-[#25D366] hover:bg-[#25D366]/90 text-white font-bold h-14 px-8">
                <a href="https://wa.me/5531998935665?text=Ol%C3%A1!%20Gostaria%20de%20solicitar%20um%20or%C3%A7amento%20para%20Troca%20de%20Embreagem%20Automotiva." target="_blank" rel="noopener noreferrer">
