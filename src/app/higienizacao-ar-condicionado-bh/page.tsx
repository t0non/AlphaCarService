...
export const metadata: Metadata = {
  ...
  description: 'Ar-condicionado com mau cheiro? Realizamos higienização com ozônio e troca de filtro de cabine em Belo Horizonte.',
};
      ...
      <main className="flex-1 bg-white pt-24 pb-16">
        <div className="container mx-auto px-6 lg:px-8 max-w-4xl">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-foreground mb-8">
            Higienização e Filtro de Ar-Condicionado
          </h1>
          
          <div className="prose prose-lg text-muted-foreground mb-12">
            <p className="text-xl font-medium text-foreground leading-relaxed">
              Manter o ar-condicionado limpo é uma questão de saúde. A higienização elimina bactérias e fungos, e a troca do filtro de cabine garante um ar puro dentro do seu veículo.
            </p>
          ...
          <div className="bg-secondary/30 p-8 rounded-xl border border-secondary text-center mt-12">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button asChild size="lg" className="bg-[#25D366] hover:bg-[#25D366]/90 text-white font-bold h-14 px-8">
                <a href="https://wa.me/5531998935665?text=Ol%C3%A1!%20Gostaria%20de%20solicitar%20um%20or%C3%A7amento%20para%20Higieniza%C3%A7%C3%A3o%20e%20Filtro%20de%20Ar-Condicionado." target="_blank" rel="noopener noreferrer">
