...
export const metadata: Metadata = {
  ...
  description: 'Diagnóstico e reparo do sistema de injeção eletrônica em Belo Horizonte. Carro falhando ou com consumo alto? Traga para a Alpha Car.',
};
      ...
      <main className="flex-1 bg-white pt-24 pb-16">
        <div className="container mx-auto px-6 lg:px-8 max-w-4xl">
          <nav className="text-sm text-muted-foreground mb-6">
            <a href="/" className="hover:underline">Home</a> &gt; <a href="/servicos" className="hover:underline">Serviços</a> &gt; <span className="text-foreground">Manutenção de Injeção Eletrônica</span>
          </nav>
          ...
          <div className="prose prose-lg text-muted-foreground mb-12">
            <p className="text-xl font-medium text-foreground leading-relaxed">
              Quando a luz da injeção acende, não significa apenas um erro genérico. Analisamos bicos injetores, sensores e corpo de borboleta para restaurar o desempenho e a economia de combustível do seu motor.
            </p>
          ...
          <div className="bg-secondary/30 p-8 rounded-xl border border-secondary text-center mt-12">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button asChild size="lg" className="bg-[#25D366] hover:bg-[#25D366]/90 text-white font-bold h-14 px-8">
                <a href="https://wa.me/5531998935665?text=Ol%C3%A1!%20Gostaria%20de%20solicitar%20um%20or%C3%A7amento%20para%20Manuten%C3%A7%C3%A3o%20de%20Inje%C3%A7%C3%A3o%20Eletr%C3%B4nica." target="_blank" rel="noopener noreferrer">
