...
export const metadata: Metadata = {
  ...
  description: 'Luz da injeção acesa ou carro falhando? Realizamos diagnóstico preciso em BH antes de trocar peças sem necessidade.',
};
      ...
      <main className="flex-1 bg-white pt-24 pb-16">
        <div className="container mx-auto px-6 lg:px-8 max-w-4xl">
          <nav className="text-sm text-muted-foreground mb-6">
            <a href="/" className="hover:underline">Home</a> &gt; <a href="/servicos" className="hover:underline">Serviços</a> &gt; <span className="text-foreground">Diagnóstico Automotivo com Scanner e Osciloscópio</span>
          </nav>
          
          <h1 className="text-4xl font-bold tracking-tight text-foreground mb-8">
            Diagnóstico Automotivo com Scanner e Osciloscópio
          </h1>
          
          <div className="prose prose-lg text-muted-foreground mb-12">
            <p className="text-xl font-medium text-foreground leading-relaxed">
              O diagnóstico automotivo é a etapa utilizada para identificar a causa de falhas elétricas, eletrônicas ou mecânicas antes da substituição de peças. Na Alpha Car Service, no bairro Saudade, a avaliação pode utilizar scanner, osciloscópio, testes elétricos e inspeção técnica.
            </p>
          ...
          <div className="bg-secondary/30 p-8 rounded-xl border border-secondary text-center mt-12">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button asChild size="lg" className="bg-[#25D366] hover:bg-[#25D366]/90 text-white font-bold h-14 px-8">
                <a href="https://wa.me/5531998935665?text=Ol%C3%A1!%20Gostaria%20de%20solicitar%20um%20or%C3%A7amento%20para%20Diagn%C3%B3stico%20Automotivo%20com%20Scanner%20e%20Oscilosc%C3%B3pio." target="_blank" rel="noopener noreferrer">
